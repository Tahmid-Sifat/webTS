export const experiences = [
  ...
  },
  {
    ...
    bullets: ["Worked with professionals in a cross-functional team", "Translated client needs into practical digital solutions", "Contributed to technical delivery and project communication"],
    skills: ["Full-stack", "Consultancy", "Teamwork"],
    link: ""
  },
  {
  ...
  },
  {
    ...
    bullets: ["Supported events and outreach activities", "Strengthened stakeholder communication", "Helped students connect with careers support"],
    skills: ["Communication", "Outreach", "Organisation"],
    link: ""
  },
  {
  ...
  },
  {
    ...
    location: "London",
    type: "Leadership",
    summary: "Coordinated student activities, excursions, events, logistics, and safety in a fast-paced international summer school setting.",
    bullets: ["Led London and regional excursions end-to-end", "Managed itineraries, transport, permissions, and day-of logistics", "Collaborated across teams to improve programme quality"],
...

  {
    ...
    bullets: ["Supported Youth Business Fair at Wembley Stadium", "Helped organise youth activities at Yeading Library", "Worked with SEND Family Support and Uxbridge F.C."],
    skills: ["Community work", "Coordination", "Adaptability"],
    link: ""
  },
  {
